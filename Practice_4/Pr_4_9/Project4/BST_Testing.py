...
def test():
    ...
    print(f'Количество произведённых сравнений при получении первой записи: {BS_Tree.compares}')
    print()
    print(f'Последняя запись из файла: {comb.get(str(numbers[9999]))}')
    print(f'Количество произведённых сравнений при получении последней записи: {BS_Tree.compares}')
    print()
    print(f'Запись в середине файла: {comb.get(str(numbers[4999]))}')
    print(f'Количество произведённых сравнений при получении записи в середине файла: {BS_Tree.compares}')
