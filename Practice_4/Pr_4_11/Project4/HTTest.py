...
def test():
    ...
    comb = Combining(ht, fw)  # Объединение работы файла и хеш-таблицы.
    ...
    print(f'Число произведённых сравнений при получении записи, расположенной в середине файла:'
          f'{HashTable.compares}')
    print()
